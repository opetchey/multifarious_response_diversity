---
title: "Analysis and creating the data for Response diversity in the context of multifarious environmental
  change"
...
### Response capacity
```{r potentialresponsediversity2, fig.cap='Potential response diversity', fig.align="center", fig.height=6, fig.width=8}
...
Absolute_plot_tot <-  ggplot(Absolute_RD, aes(x = correlation, y = value, color = community)) +
  ...
  theme_bw(base_size = 12)  + ggtitle("E1 dominant environmental variable") +
  guides(color=guide_legend(title="Diversity in responses to E1"))
...
Absolute_RD_ms <- Absolute_RD_ms + plot_layout(guides = "collect") + ggtitle("Equal effect of E1 and E2")
...
## Summary plot -  Directional Response diversity as Response Dissimilarity

```{r SummaryPlot3, fig.align="center", fig.height=15, fig.width=22, fig.cap="Summary plot showing the effects of the determinants on directional response diveristy measured as Dissimilarity"}

theme_set(theme_classic(base_size = 15))
diss1 <-  ggplot(dd_dissimilarity_scenario1, aes(x = z1, y = rdiv, color = E1_mean)) +
  # scale_y_continuous(limits = c(0.99, 1.005), expand = c(0.02, 0.02)) +
  scale_color_uchicago() +
  labs(x = "E1 optimum diversity", y = "Dissimilarity (derivatives)") +
  theme(
    legend.position = "none",
    axis.title = element_text(size = 16),
    panel.grid = element_blank()
...
## Summary plot - Directional Response diversity as Response Divergence

```{r SummaryPlot1.4, fig.align="center", fig.height=15, fig.width=22, fig.cap="Summary plot showing the effects of the determinants on directional response diveristy measured as Divergence (same as in the main manuscript"}
theme_set(theme_classic(base_size = 15))
