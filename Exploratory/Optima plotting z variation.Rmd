...
```{r plotoptimum5, fig.cap='Position of the optimum for z1 and z2 in the 3 different communities', fig.align="center", fig.height=6, fig.width=8}
...
## Summary plot - Effects of E1 diversity and correlation between environmental variables on response diversity 
...
#dd_plot1$E1 <- factor(dd_plot1$E1, levels = c("low", "medium", "high"))
theme_set(theme_classic(base_size = 12))

g1.1 <-
  ggplot(dd_plot1, aes(x = cor, y = rdiv, color = E1)) +
...
#dd_plot2$E1 <- factor(dd_plot2$E1, levels = c("low", "medium", "high"))
g1.2 <-
  ggplot(dd_plot2, aes(x = cor, y = sign, color = E1)) +
      scale_color_viridis_c()+
...
s <- 10
# community 1 - low variation in z1. 
species_pars$z1_range <- 2.5
species_pars$z2_range <- 2.5
...
## Summary plot - Effects of E1 and z2 diversity and correlation between environmental variables on response diversity 
...
dd_plot1 <- rbind(dd1[,c(1,3:4)], dd2[,c(1,3:4)], dd3[,c(1,3:4)],
                  dd4[,c(1,3:4)], dd5[,c(1,3:4)], dd6[,c(1,3:4)], 
                  dd7[,c(1,3:4)], dd8[,c(1,3:4)], dd9[,c(1,3:4)])
#dd_plot1$z1 <- factor(dd_plot1$E1, levels = c("low", "medium", "high"))
theme_set(theme_classic(base_size = 12))
...
dd1z2$cor <- "negative"
dd1z2$E2 <- optima_com1$E2

dd2z2 <- data.frame(rdiv_2[, c("rdiv", "sign")]) 
dd2z2$cor <- "negative"
dd2z2$E2 <- optima_com2$E2

dd3z2 <- data.frame(rdiv_3[, c("rdiv", "sign")]) 
dd3z2$cor <- "negative"
dd3z2$E2 <- optima_com2$E2
```

## Low fluctuation in environmental change - negative correlation 
Increasing variance in E1 and z2 - negative correlation between env variables (E1 and E2) with *low* fluctuations
...
# create communities
s <- 10
# community 1 - low variation in E1 high in z2. 
species_pars$z1_range <- 1.5
species_pars$z2_range <- 50
...
```{r SummaryPlot3,fig.align="center", fig.height=8, fig.width=10, fig.cap="Influence of the correlation between environmental variables and diversity in E1 and z2 on response diversity. In this scenario, diversity in E1 increases with negative correlation with respect to diversity in z2. (a) Effects of the correlation between environmental variables and E1 diversity on response diversity measured as dissimilarity (sign insensitive measure). (b) Effects of the correlation between environmental variables and E1 diversity on response diversity measured as divergence (sign sensitive measure)."}
dd_plot1 <- rbind(dd1[,c(1,3:4)], dd2[,c(1,3:4)], dd3[,c(1,3:4)],
                  dd4[,c(1,3:4)], dd5[,c(1,3:4)], dd6[,c(1,3:4)], 
                  dd7[,c(1,3:4)], dd8[,c(1,3:4)], dd9[,c(1,3:4)])
#dd_plot1$E1 <- factor(dd_plot1$E1, levels = c("low", "medium", "high"))
...
### Focus on z2 
```{r SummaryPlotz2,fig.align="center", fig.height=8, fig.width=10, fig.cap="Focusing on z2. (a) Effects of the correlation between environmental variables and E1 diversity on response diversity measured as dissimilarity (sign insensitive measure). (b) Effects of the correlation between environmental variables and E1 diversity on response diversity measured as divergence (sign sensitive measure)."}
...
g1.1 <-
  ggplot(dd_plot1, aes(x = cor, y = rdiv, color = E2)) +
   # scale_y_continuous(limits = c(0.99, 1.005), expand = c(0.02, 0.02)) +
    scale_color_viridis_c() +
    labs(x = NULL, y = "Dissimilarity (derivatives)") +
    theme(
...
g1.2 <-
  ggplot(dd_plot2, aes(x = cor, y = sign, color = E2)) +
    scale_color_viridis_c() +
    labs(x = NULL, y = "Divergence (sign sensitive)") +
    theme(
      legend.position = "none",
