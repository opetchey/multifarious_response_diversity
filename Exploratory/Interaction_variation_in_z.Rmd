...
```{r plot3env, fig.cap='Environmental variables with *high* variation and positive correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-350; E1min<-250
E2max<- 70; E2min<- -25
library(MASS)
sample_size <- 15                                       
...
```{r plot5env, fig.cap='Environmental variables with *high* variation and no correlation.Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario. (a) E1 changing over time. (b) E2 changing over time.', fig.align="center", fig.height=6, fig.width=12}
E1max<-350; E1min<-250
E2max<- 70; E2min<- -25
library(MASS)
sample_size <- 15                                       
...
```{r plot2.3env, fig.cap='Environmental variables with *high* variation and positive correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-350; E1min<-250
E2max<- 70; E2min<- -25
library(MASS)
sample_size <- 15                                       
...
```{r plot2.4env, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
...
```{r plot13env, fig.cap='Environmental variables with *high* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
# Specify the correlation E1 and E2 
#negative in this example and high variation in E1 and E2 
E1max<-350; E1min<-250
E2max<- 70; E2min<- -25
...
Absolute_plot_1 <- Absolute_plot_1 + ggtitle("Only variation in Temperature optimum diversity") + scale_y_continuous(breaks = seq(0, 1.2, by = 0.1)) +
  theme_classic(base_size = 15) 
Absolute_plot_2 <- Absolute_plot_2 + ggtitle("Variation in Temperature and Salinity\noptimum diversity - positive correlation") + scale_y_continuous(breaks = seq(0, 1.2, by = 0.1))+
  theme_classic(base_size = 15) 
Absolute_plot_3 <- Absolute_plot_3 + ggtitle("Variation in Temperature and Salinity\noptimum diversity - negative correlation") + scale_y_continuous(breaks = seq(0, 1.2, by = 0.1))+
  theme_classic(base_size = 15) 

combined_absolute <- Absolute_plot_1 + Absolute_plot_2 + Absolute_plot_3  & theme(legend.position = "bottom")  & labs(col = "community")
combined_absolute + plot_layout(guides = "collect") 
```
...
```{r plot3.3env, fig.cap='Environmental variables with *high* variation and positive correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-350; E1min<-250
E2max<- 70; E2min<- -25
library(MASS)
sample_size <- 15                                       
...
```{r plot3.5env, fig.cap='Environmental variables with *high* variation and no correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-350; E1min<-250
E2max<- 70; E2min<- -25
library(MASS)
sample_size <- 15                                       
...
rdiv1.2 <- rdiv1.2 + ggtitle("Only variation in Temperature optimum diversity") + labs(tag = "(a)")
...
sign1.2 <- sign1.2 + ggtitle("Only variation in Temperature optimum diversity") + labs(tag = "(d)")
