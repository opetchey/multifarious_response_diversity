...
We now create 3 communities. Community 1 is characterized by low diversity in z1, community 2 has medium diversity in z1, and community 3 has high diversity in z1. z2 is constant in the 3 communities and fixed to a medium level of diversity (z2_mean = 20, no variation). 
...
```{r}
## Set species parameters - peaky response curves change in w1, w2 (reduced), and b1, b2 (increased)
...
# Reducing mean z2 in a peaky scenario 
