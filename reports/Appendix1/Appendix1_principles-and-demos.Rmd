...
p1 <- p1 + guides(fill = guide_legend(title = "Growth Rate", keywidth = 1, keyheight = 1, direction = "horizontal"))
...
ggarrange(p1, second, widths = c(2,2))
```
...
fig6 <- p4 + labs(color = "Directional \n  Derivative") +
...
ggsave(fig6, file="/Users/francesco/Documents/GitHub/multifarious_response_diversity/Fig6.jpg", width=6, height=4)
...
```{r}
pagedown::chrome_print("file:///Users/francesco/Documents/GitHub/multifarious_response_diversity/reports/Appendix1/Appendix1_principles-and-demos.html", output = "Appendix1_principle-and-demos.pdf")
```
