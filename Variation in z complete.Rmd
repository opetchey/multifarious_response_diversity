...
rdiv2 <- rdiv2 + ggtitle("Variation in z1 and z2 - positive correlation") + labs(tag = "(b)")
rdiv3 <- rdiv3 + ggtitle("Variation in z1 and z2 - negative correlation") + labs(tag = "(c)")

sign1 <- sign1 + ggtitle("Only variation in z1") + labs(tag = "(d)")
sign2 <- sign2 + ggtitle("Variation in z1 and z2 - positive correlation") + labs(tag = "(e)")
sign3 <- sign3 + ggtitle("Variation in z1 and z2 - negative correlation") + labs(tag = "(e)")
