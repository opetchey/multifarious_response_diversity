...
```{r plot2env, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
# Specify the correlation E1 and E2 
#negative in this example and high variation in E1 and E2 
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
...
```{r plot4env, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
...
```{r plot6env_b, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
...
```{r plot2.2env, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
# Specify the correlation E1 and E2 
#negative in this example and high variation in E1 and E2 
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
...
```{r plot6env_a, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
...
```{r plot3.2env, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
# Specify the correlation E1 and E2 
#negative in this example and high variation in E1 and E2 
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
...
```{r plot3.4env, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
...
```{r plot2.6env, fig.cap='Environmental variables with *low* variation and negative correlation. Different scenarios of E1 and E2 changing over time (a) low mean value of E1. (b) low mean value of E2. (c) medium mean value of E1. (d) medium mean value of E2. (e) high mean value of E1. (f) high mean value of E2. The dotted line represents the mean value of the environemntal variable for each scenario.', fig.align="center", fig.height=6, fig.width=8}
E1max<-325; E1min<-275
E2max<-47; E2min<- -5
