...
rdiv1.3 <- g1.3 +
  geom_jitter(size = 2, alpha = 0.25, width = 0.2) +
  stat_summary(fun = median, geom = "point", size = 5) + labs(tag = "(a)")
...
combined + plot_layout(guides = "collect") 
effect_optimum_diversity <- combined + plot_layout(guides = "collect")
ggsave(effect_optimum_diversity, file="/Users/francesco/Documents/GitHub/multifarious_response_diversity/effect_optimum_diversity_SAME_curve.jpg", width=14, height=10)
...
combined + plot_layout(guides = "collect")
effect_correlation_env_change <- combined + plot_layout(guides = "collect")
ggsave(effect_correlation_env_change, file="/Users/francesco/Documents/GitHub/multifarious_response_diversity/effect_correlation_env_change_SAME_curve.jpg", width=14, height=10)
