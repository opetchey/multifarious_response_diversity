...
rdiv_1$rdiv<-apply(rdiv_1[,c(4:23)], 1, resp_div, sign_sens = F)
rdiv_1$sign<-apply(rdiv_1[,c(4:23)], 1, resp_div, sign_sens = T)
...
# actual calculation for only the same species used above
rdiv_2$rdiv<-apply(rdiv_2[,c(4:23)], 1, resp_div, sign_sens = F)
rdiv_2$sign<-apply(rdiv_2[,c(4:23)], 1, resp_div, sign_sens = T)
...
# actual calculation for only the same species used above
rdiv_3$rdiv<-apply(rdiv_3[,c(4:23)], 1, resp_div, sign_sens = F)
rdiv_3$sign<-apply(rdiv_3[,c(4:23)], 1, resp_div, sign_sens = T)
...
```{r}
dd1 <- data.frame(rdiv_1[, c(24:25)]) 
dd1$cor <- "negative"
dd1$z1 <- "low"

dd2 <- data.frame(rdiv_2[, c(24:25)]) 
dd2$cor <- "negative"
dd2$z1 <- "medium"

dd3 <- data.frame(rdiv_3[, c(24:25)]) 
dd3$cor <- "negative"
dd3$z1 <- "high"
```
...
```{r}
new_rdiv <- rdiv_1[, c(24)]
new_sign <- rdiv_1[, c(25)]
...
new_rdiv <- rdiv_2[, c(24)]
new_sign <- rdiv_2[, c(25)]
...
new_rdiv <- rdiv_3[, c(24)]
new_sign <- rdiv_3[, c(25)]
...
```{r}
dd4 <- data.frame(rdiv_1[, c(24:25)]) 
dd4$cor <- "positive"
dd4$z1 <- "low"

dd5 <- data.frame(rdiv_2[, c(24:25)]) 
dd5$cor <- "positive"
dd5$z1 <- "medium"

dd6 <- data.frame(rdiv_3[, c(24:25)]) 
dd6$cor <- "positive"
dd6$z1 <- "high"
```
...
```{r}
dd7 <- data.frame(rdiv_1[, c(24:25)]) 
dd7$cor <- "no_cor"
dd7$z1 <- "low"

dd8 <- data.frame(rdiv_2[, c(24:25)]) 
dd8$cor <- "no_cor"
dd8$z1 <- "medium"

dd9 <- data.frame(rdiv_3[, c(24:25)]) 
dd9$cor <- "no_cor"
dd9$z1 <- "high"
```
...
```{r}
dd1z2 <- data.frame(rdiv_1[, c(24:25)]) 
dd1z2$cor <- "negative"
dd1z2$z2 <- "high"

dd2z2 <- data.frame(rdiv_2[, c(24:25)]) 
dd2z2$cor <- "negative"
dd2z2$z2 <- "medium"

dd3z2 <- data.frame(rdiv_3[, c(24:25)]) 
dd3z2$cor <- "negative"
dd3z2$z2 <- "low"
```
...
```{r}
dd4z2 <- data.frame(rdiv_1[, c(24:25)]) 
dd4z2$cor <- "positive"
dd4z2$z2 <- "high"

dd5z2 <- data.frame(rdiv_2[, c(24:25)]) 
dd5z2$cor <- "positive"
dd5z2$z2 <- "medium"

dd6z2 <- data.frame(rdiv_3[, c(24:25)]) 
dd6z2$cor <- "positive"
dd6z2$z2 <- "low"
```
## Low fluctuation in environmental change - positive correlation 
...
```{r}
dd7z2 <- data.frame(rdiv_1[, c(24:25)]) 
dd7z2$cor <- "no_cor"
dd7z2$z2 <- "high"

dd8z2 <- data.frame(rdiv_2[, c(24:25)]) 
dd8z2$cor <- "positive"
dd8z2$z2 <- "medium"

dd9z2 <- data.frame(rdiv_3[, c(24:25)]) 
dd9z2$cor <- "positive"
dd9z2$z2 <- "low"
```
## Low fluctuation in environmental change - no correlation
