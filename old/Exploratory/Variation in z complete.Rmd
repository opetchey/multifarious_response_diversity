...
```{r plotoptimum5, fig.cap='Position of the optimum for E1 and E2 in the 3 different communities', fig.align="center", fig.height=6, fig.width=8}
...
```{r plotcomm1.2_neg, fig.cap='Community 1, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
s <- 10
# community 1 - low variation in z1. 
species_pars$z1_range <- 1.5
...
```{r plotcomm2.1_neg, fig.cap='Community 2, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
...
```{r plotcomm3.2_neg, fig.cap='Community 3, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
species_pars$z1_range <- 50
...
```{r plotcomm1.3_neg, fig.cap='Community 1, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
s <- 10
...
```{r plotcomm2.3_neg, fig.cap='Community 2, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
species_pars$z1_range <- 25
species_pars$z2_range <- 25
...
```{r plotcomm3.3_neg, fig.cap='Community 3, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
species_pars$z1_range <- 50
species_pars$z2_range  <- 1.5
...
```{r}
dd1z2 <- data.frame(rdiv_1[, c("rdiv", "sign")]) 
dd1z2$cor <- "negative"
dd1z2$z2 <- "high"

dd2z2 <- data.frame(rdiv_2[, c("rdiv", "sign")]) 
dd2z2$cor <- "negative"
dd2z2$z2 <- "medium"

dd3z2 <- data.frame(rdiv_3[, c("rdiv", "sign")]) 
dd3z2$cor <- "negative"
dd3z2$z2 <- "low"
```
...
```{r}
dd4z2 <- data.frame(rdiv_1[, c("rdiv", "sign")]) 
dd4z2$cor <- "positive"
dd4z2$z2 <- "high"

dd5z2 <- data.frame(rdiv_2[, c("rdiv", "sign")]) 
dd5z2$cor <- "positive"
dd5z2$z2 <- "medium"

dd6z2 <- data.frame(rdiv_3[, c("rdiv", "sign")]) 
dd6z2$cor <- "positive"
dd6z2$z2 <- "low"
```
## Low fluctuation in environmental change - positive correlation 
...
```{r}
dd7z2 <- data.frame(rdiv_1[, c("rdiv", "sign")]) 
dd7z2$cor <- "no_cor"
dd7z2$z2 <- "high"

dd8z2 <- data.frame(rdiv_2[, c("rdiv", "sign")]) 
dd8z2$cor <- "positive"
dd8z2$z2 <- "medium"

dd9z2 <- data.frame(rdiv_3[, c("rdiv", "sign")]) 
dd9z2$cor <- "positive"
dd9z2$z2 <- "low"
```
## Low fluctuation in environmental change - no correlation
...
Fixing  z2_mean = 5, with variation according to the different scenarios
...
```{r plotcomm1.3_negz2, fig.cap='Community 1, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
s <- 10
# community 1 - low variation in z1 high in z2. 
species_pars$z1_range <- 1.5
species_pars$z2_range <- 50
...
```{r plotcomm2.3_negz2, fig.cap='Community 2, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
species_pars$z1_range <- 25
species_pars$z2_range <- 25
...
```{r plotcomm3.3_negz2, fig.cap='Community 3, single species responses. (a) Species responses to the gradient of E1. Different colour lines show the dependency of the rate to the second environmental variable (E2). (b) Species responses to the gradient of E2. Different colour lines show the dependency of the rate to the second environmental variable (E1).', fig.align="center", fig.height=20, fig.width=12}
species_pars$z1_range <- 50
vz2_range <- 1.5
...
### Position of the optimum 
```{r plotoptimum4, fig.cap='Position of the optimum for E1 and E2 in the 3 different communities', fig.align="center", fig.height=6, fig.width=8}
optima <- rbind(optima_com1, optima_com2, optima_com3)
optima %>%  ggplot(aes(x = E1, y = E2, col = as.factor(community))) +
  geom_point() +
  labs(x = "Optimum E1", y = "Optimum E2")
