...
knitr::include_graphics(here("Second version/assets/illustration_of_directional_derivatives.png"))
```
...
```{r example-1, fig.cap='(ref:gamtest-species1)', fig.align="center", fig.height=3, fig.width=8}
...
```{r example-2, fig.cap='(ref:gamtest-species1)', fig.align="center", fig.height=3, fig.width=8}
...
```{r example-3, fig.cap='(ref:gamtest-species1)', fig.align="center", fig.height=3, fig.width=8}
## gam with interaction
...
```{r example-4, fig.cap='(ref:gamtest-species1)', fig.align="center", fig.height=3, fig.width=8}
## gam without interaction
...
p_E1 <- refs_ts %>% 
  ...
  labs(y = "E1", x = "Time", tag = "(a)") + theme_bw(base_size = 15)

p_E2 <- refs_ts %>% 
  ggplot(aes(x = time, y = E2)) + geom_line(col = "red", size = 1.5) +
  labs(y = "E2", x = "Time",tag = "(b)") + theme_bw(base_size = 15)
...
p_E1 <- refs_neg %>% 
  ggplot(aes(x = time, y = E1)) + geom_line(col = "blue", size = 1.5) +
  labs(tag = "(a)") + ylab("E1") + theme_bw(base_size = 15)

p_E2 <- refs_neg %>% 
  ggplot(aes(x = time, y = E2)) + geom_line(col = "red", size = 1.5) +
  labs(tag = "(b)") + ylab("E2") + theme_bw(base_size = 15)
...
```{r}
#Create pdf report
 pagedown::chrome_print(here("Second version/Appendix1_principles-and-demos_v2.html"), output = "Appendix1_principle-and-demos.pdf")
```
